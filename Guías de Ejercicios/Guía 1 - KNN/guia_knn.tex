...
\subsection{Ejercicios de Clasificación}

\subsubsection{Clasificación Simple}
...
\subsubsection{Efecto del Parámetro k}
...
\subsubsection{Múltiples Variables}
...
\begin{table}[H]
    ...
    \begin{tabular}{cccc}
        ...
        35 & 40000 & 12000 & Riesgo Bajo \\
        45 & 35000 & 25000 & Riesgo Alto \\
        50 & 75000 & 30000 & Riesgo Alto \\
...
\begin{enumerate}
    \item Calculá las distancias al punto (38, 70000, 15000) sin normalizar.
    \item Encontrá los 3 vecinos más cercanos al punto sin normalizar y clasificá el nuevo cliente.
    \item Normalizá los datos.
    \item Encontrá los 3 vecinos más cercanos al punto normalizado y clasificá el nuevo cliente.
...
\subsubsection{Pesos por Distancia}
...
\subsection{Ejercicios de Regresión}
...
\begin{enumerate}
    ...
    \item Calculá las distancias del punto (1800, 14) a todos los puntos normalizados.
...
\subsubsection{Efecto de k en Regresión}
...
\subsubsection{Pesos en Regresión}
...
\subsubsection{Análisis de Datos Manual}
...
\begin{enumerate}
    \item Distancias euclidianas a todos los puntos:
    \begin{itemize}
        \item (1.4, 0.2) Setosa: $\sqrt{(4.8-1.4)^2 + (1.6-0.2)^2} = \sqrt{11.56 + 1.96} = 3.68$
        \item (1.4, 0.2) Setosa: $\sqrt{(4.8-1.4)^2 + (1.6-0.2)^2} = \sqrt{11.56 + 1.96} = 3.68$
        \item (1.3, 0.2) Setosa: $\sqrt{(4.8-1.3)^2 + (1.6-0.2)^2} = \sqrt{12.25 + 1.96} = 3.77$
        \item (4.7, 1.4) Versicolor: $\sqrt{(4.8-4.7)^2 + (1.6-1.4)^2} = \sqrt{0.01 + 0.04} = 0.22$
        \item (4.5, 1.5) Versicolor: $\sqrt{(4.8-4.5)^2 + (1.6-1.5)^2} = \sqrt{0.09 + 0.01} = 0.32$
        \item (4.9, 1.5) Versicolor: $\sqrt{(4.8-4.9)^2 + (1.6-1.5)^2} = \sqrt{0.01 + 0.01} = 0.14$
        \item (6.0, 2.5) Virginica: $\sqrt{(4.8-6.0)^2 + (1.6-2.5)^2} = \sqrt{1.44 + 0.81} = 1.50$
        \item (5.1, 1.9) Virginica: $\sqrt{(4.8-5.1)^2 + (1.6-1.9)^2} = \sqrt{0.09 + 0.09} = 0.42$
        \item (5.9, 2.1) Virginica: $\sqrt{(4.8-5.9)^2 + (1.6-2.1)^2} = \sqrt{1.21 + 0.25} = 1.21$
    \end{itemize}
    
    \item Los 3 vecinos más cercanos son:
    \begin{enumerate}
        \item (4.9, 1.5) - Versicolor (distancia: 0.14)
        \item (4.7, 1.4) - Versicolor (distancia: 0.22)
        \item (5.1, 1.9) - Virginica (distancia: 0.42)
    \end{enumerate}
    
    \item Clasificación: Versicolor (2 votos vs 1 voto de Virginica)
\end{enumerate}

\subsubsection{Efecto del Parámetro k}

\begin{enumerate}
    \item Con k=1: Versicolor (punto más cercano)
    \item Con k=5: Los 5 vecinos más cercanos son: (4.9,1.5) Versicolor, (4.7,1.4) Versicolor, (5.1,1.9) Virginica, (4.5,1.5) Versicolor, (5.9,2.1) Virginica. Resultado: Versicolor (3 votos vs 2)
    \item Con k=7: Los 7 vecinos más cercanos incluyen: 4 Versicolor, 2 Virginica, 1 Setosa. Resultado: Versicolor (4 votos vs 2 vs 1)
    \item Los resultados pueden diferir porque con k=1 solo se considera el vecino más cercano, mientras que con k=5 o k=7 se consideran más puntos, lo que puede cambiar la clasificación si hay puntos de otras clases cercanos. En este caso, Versicolor mantiene la mayoría en todos los escenarios.
\end{enumerate}
...
\begin{enumerate}
    \item \textbf{Distancias SIN Normalizar (k=3)}
    
    El punto a clasificar es \textbf{P(38, 70000, 15000)}. Calculamos la distancia euclidiana a todos los puntos de entrenamiento:
    
    \begin{align*}
        A(25, 30000, 5000) & = \sqrt{(38-25)^2 + (70000-30000)^2 + (15000-5000)^2} \\ &= \sqrt{13^2 + 40000^2 + 10000^2} \\ &= 41231
    \end{align*}

    \begin{align*}
        B(30, 45000, 8000) & = \sqrt{(38-30)^2 + (70000-45000)^2 + (15000-8000)^2} \\ &= \sqrt{8^2 + 25000^2 + 7000^2} \\ &= 25962
    \end{align*}

    \begin{align*}
        C(35, 40000, 12000) & = \sqrt{(38-35)^2 + (70000-40000)^2 + (15000-12000)^2} \\ &= \sqrt{3^2 + 30000^2 + 3000^2} \\ &= 30150
    \end{align*}

    \begin{align*}
        D(45, 35000, 25000) & = \sqrt{(38-45)^2 + (70000-35000)^2 + (15000-25000)^2} \\ &= \sqrt{(-7)^2 + 35000^2 + (-10000)^2} \\ &= 36401
    \end{align*}

    \begin{align*}
        E(50, 75000, 30000) & = \sqrt{(38-50)^2 + (70000-75000)^2 + (15000-30000)^2} \\ &= \sqrt{(-12)^2 + (-5000)^2 + (-15000)^2} \\ &= 15811
    \end{align*}

    \begin{align*}
        F(55, 55000, 35000) & = \sqrt{(38-55)^2 + (70000-55000)^2 + (15000-35000)^2} \\ &= \sqrt{(-17)^2 + 15000^2 + (-20000)^2} \\ &= 25000
    \end{align*}

    \item \textbf{Vecinos:} E (Riesgo Alto), F (Riesgo Alto), B (Riesgo Bajo).
    
    \textbf{Clasificación: Riesgo Alto} (2 votos vs 1).

    \item \textbf{Normalizando}
    
    Punto P(38, 70000, 15000) se normaliza a \textbf{P\_norm(0.43, 0.89, 0.33)}.

    \begin{table}[H]
    \centering
    \begin{tabular}{ccccc}
        \toprule
        \textbf{Punto} & \textbf{Edad Norm} & \textbf{Ingresos Norm} & \textbf{Deuda Norm} & \textbf{Clase} \\
        \midrule
        A & 0.00 & 0.00 & 0.00 & RB \\
        B & 0.17 & 0.33 & 0.10 & RB \\
        C & 0.33 & 0.22 & 0.23 & RB \\
    ...
    \item \textbf{Distancias Normalizadas}

    Ahora, calculamos las distancias desde \textbf{P\_norm(0.43, 0.89, 0.33)}:

    \begin{align*}
        A\_norm &= \sqrt{(0.43-0)^2 + (0.89-0)^2 + (0.33-0)^2} \approx 1.04 \\
        B\_norm &= \sqrt{(0.43-0.17)^2 + (0.89-0.33)^2 + (0.33-0.1)^2} \approx \textbf{0.66} \\
        C\_norm &= \sqrt{(0.43-0.33)^2 + (0.89-0.22)^2 + (0.33-0.23)^2} \approx \textbf{0.68} \\
        D\_norm &= \sqrt{(0.43-0.67)^2 + (0.89-0.11)^2 + (0.33-0.67)^2} \approx 0.88 \\
        E\_norm &= \sqrt{(0.43-0.83)^2 + (0.89-1)^2 + (0.33-0.83)^2} \approx \textbf{0.65} \\
        F\_norm &= \sqrt{(0.43-1)^2 + (0.89-0.56)^2 + (0.33-1)^2} \approx 0.94
    \end{align*}
    
    \textbf{Vecinos:} E\_norm (Riesgo Alto), B\_norm (Riesgo Bajo), C\_norm (Riesgo Bajo).

    \textbf{Clasificación: Riesgo Bajo} (2 votos vs 1).

    \item La normalización cambió todo. Sin normalizar clasificaba como Riesgo Alto porque la variable ingresos dominaba.
...
\begin{enumerate}
    \item \textbf{Normalización de datos (min-max scaling):}
    
    Rangos: Publicidad (2000), Precio (10)
    ...
    Punto a predecir: (1800, 14) se normaliza a (0.40, 0.40)
    
    \item \textbf{Distancias desde el punto normalizado (0.40, 0.40):}
    
    \begin{align*}
        d_1 &= \sqrt{(0.40-0.00)^2 + (0.40-0.00)^2} = \sqrt{0.16 + 0.16} = 0.57 \\
        d_2 &= \sqrt{(0.40-0.25)^2 + (0.40-0.20)^2} = \sqrt{0.0225 + 0.04} = 0.25 \\
        d_3 &= \sqrt{(0.40-0.50)^2 + (0.40-0.50)^2} = \sqrt{0.01 + 0.01} = 0.14 \\
        d_4 &= \sqrt{(0.40-0.75)^2 + (0.40-0.80)^2} = \sqrt{0.1225 + 0.16} = 0.53 \\
        d_5 &= \sqrt{(0.40-1.00)^2 + (0.40-1.00)^2} = \sqrt{0.36 + 0.36} = 0.85
    \end{align*}
    
    \item \textbf{Los 3 vecinos más cercanos son:}
    \begin{enumerate}
        \item Punto 3: (2000, 15) → Ventas: 700 (distancia: 0.14)
        \item Punto 2: (1500, 12) → Ventas: 600 (distancia: 0.25)
        \item Punto 4: (2500, 18) → Ventas: 800 (distancia: 0.53)
    \end{enumerate}
    
    \item \textbf{Predicción con k=3:} $(700 + 600 + 800) / 3 = 700$ ventas
    
    \item \textbf{Con k=5:} Se incluyen todos los puntos, predicción: $(500 + 600 + 700 + 800 + 900) / 5 = 700$ ventas
    
    En este caso particular, ambas predicciones dan el mismo resultado porque los datos están bien distribuidos.
\end{enumerate}
...
\subsection{Análisis de Datos Manual}
