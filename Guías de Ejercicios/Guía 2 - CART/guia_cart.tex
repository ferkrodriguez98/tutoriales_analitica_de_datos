...
El Gini inicial (5 Si, 5 No) es 0.5. Hay un empate en la primera división (Gini ponderado de 0.167) entre \texttt{participa\_clase}, \texttt{usa\_material\_extra} y \texttt{horas\_estudio <= 2.5}.
