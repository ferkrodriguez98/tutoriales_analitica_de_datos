...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item (4.5, 1.5) - Versicolor (distancia: 0.32)
    \end{enumerate}
...
\begin{enumerate}
    ...
    \item Con k=5: Los 5 vecinos más cercanos son: (4.9,1.5) Versicolor, (4.7,1.4) Versicolor, (4.5,1.5) Versicolor, (5.1,1.9) Virginica, (5.9,2.1) Virginica. Resultado: Versicolor (3 votos vs 2)
    \item Con k=7: Los 7 vecinos más cercanos incluyen: 3 Versicolor, 3 Virginica, 1 Setosa. Resultado: Versicolor (desempate por el más cercano)
